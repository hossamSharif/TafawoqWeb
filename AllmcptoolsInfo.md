...
chrom_mcp tools 
 1. chrome_navigate - Navigate to a URL in the browser
  2. chrome_screenshot - Take a screenshot of the current page
  3. chrome_click - Click on an element on the page
  4. chrome_fill - Fill in form fields/input elements
  5. chrome_evaluate - Execute JavaScript in the browser context
  6. chrome_get_content - Get the page content (HTML or text)
  7. chrome_scroll - Scroll the page
  8. chrome_select - Select options from dropdown menus
  9. chrome_hover - Hover over elements

  If you have Chrome MCP installed, you can check your MCP server configuration to see the exact tools available.     
  Would you like me to help you set up or configure Chrome MCP for this project?
