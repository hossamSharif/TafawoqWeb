# Claude API Prompt - امتحان قدرات للقسم العلمي

This document contains the exact prompts sent to Claude API when generating a scientific track exam (المسار العلمي).
...
```
قم بإنشاء 10 سؤال كمي لاختبار القدرات العامة.

الدفعة: 1
المسار الأكاديمي: علمي (مستوى متقدم)
التصنيفات المطلوبة: algebra، geometry، statistics
...
تنسيق معرف السؤال: quant_0_{رقم_تسلسلي}
مثال: quant_0_01, quant_0_02, ...
