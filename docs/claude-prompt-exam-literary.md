# Claude API Prompt - امتحان قدرات للقسم الأدبي

This document contains the exact prompts sent to Claude API when generating a literary track exam (المسار الأدبي).
...
```
قم بإنشاء 10 سؤال لفظي لاختبار القدرات العامة.

الدفعة: 1
المسار الأكاديمي: أدبي (مستوى أساسي)
التصنيفات المطلوبة: reading-comprehension، sentence-completion، analogy
