# Claude API Prompt - تدريب القسم الكمي

This document contains the exact prompts sent to Claude API when generating quantitative practice questions (تدريب القسم الكمي).
...
```
قم بإنشاء 5 سؤال كمي لاختبار القدرات العامة.

الدفعة: 1
المسار الأكاديمي: علمي (مستوى متقدم)
التصنيفات المطلوبة: algebra، geometry
